...
// returned from the server. This function receives all the categories from the server
// and processes them: choose random category, retrieve home HTML snippet, insert that
